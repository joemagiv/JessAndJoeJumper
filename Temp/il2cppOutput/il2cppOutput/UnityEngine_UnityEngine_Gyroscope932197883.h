...
struct  Gyroscope_t932197883  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_m_GyroIndex_0() { return static_cast<int32_t>(offsetof(Gyroscope_t932197883, ___m_GyroIndex_0)); }
