...
#include "System_Core_System_Collections_Generic_HashSet_1_Li814928558.h"
...
struct LinkU5BU5D_t1020810971  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) Link_t814928558  m_Items[1];

public:
	inline Link_t814928558  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Link_t814928558 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Link_t814928558  value)
	{
		m_Items[index] = value;
	}
};
